...
class Trainer(object):
    ...
    def __init__(self, cfg, mode="train"):
        ...
        summary(self.model, input_size=(1, 3, 32, 100))
    ...
    def train(self):
        ...
        for epoch in range(start_epoch, epoch_num + 1):
            ...
            for idx, batch in enumerate(self.train_dataloader):
                ...
                if self.local_rank == 0 and epoch > (epoch_num - epoch_num // 10):
                    with torch.no_grad():
                        loss_currn = loss["loss"].detach().cpu().numpy().mean()
                        loss_avg = ((loss_avg * (ema_stpe - 1)) + loss_currn) / (
                            ema_stpe
                        )
                        if ema_stpe == 1:
                    ...
                    if (
                        ...
                        ema_eval_iter += 1
                        if (
                            ema_cur_metric[self.eval_class.main_indicator]
